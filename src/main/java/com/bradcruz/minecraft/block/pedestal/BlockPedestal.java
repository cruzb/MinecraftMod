...
import com.bradcruz.minecraft.ModGuiHandler;
import com.bradcruz.minecraft.WitchMod;
import com.bradcruz.minecraft.block.BlockTileEntity;
    ...
    public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
        if (!world.isRemote) {
            ...
            if (!player.isSneaking()) {
                ...
                player.openGui(WitchMod.instance, ModGuiHandler.PEDESTAL, world, pos.getX(), pos.getY(), pos.getZ());
            }
        }
        return true;
    }
